...
Для взаимодействия микросервисов буду использовать REST API, так как асинхронное взаимодействие пока не является критичным на данном этапе учебного проекта, что позволяет сохранить архитектуру простой и понятной.
